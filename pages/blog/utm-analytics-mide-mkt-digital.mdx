...
<div className=" max-w-sm m-auto " >
	<Image src="/img/posts/2021/04/camping-url-builder.jpg" loading="lazy" alt="campaign url builder" width="100%" height="100%" layout="responsive" objectFit="contain"/>
</div>
...
<div className=" max-w-sm m-auto " >
	<Image src="/img/posts/2021/04/camping-url-builder-form.jpg" loading="lazy" alt="utm builder form" width="100%" height="100%" layout="responsive" objectFit="contain"/>
</div>
...
<div className=" max-w-sm m-auto " >
	<Image src="/img/posts/2021/04/camping-url-builder-form-full.jpg" loading="lazy" alt="utm builder content" width="100%" height="100%" layout="responsive" objectFit="contain"/>
</div>
...
<div className=" max-w-sm m-auto " >
	<Image src="/img/posts/2021/04/camping-url-builder-shortener.jpg" loading="lazy" alt="camping url builder shortener" width="100%" height="100%" layout="responsive" objectFit="contain"/>
</div>
...
<div className=" max-w-sm m-auto " >
	<Image src="/img/posts/2021/04/camping-url-builder-shortener-2.jpg" loading="lazy" alt="url acortada utm generada con google" width="100%" height="100%" layout="responsive" objectFit="contain"/>
</div>
