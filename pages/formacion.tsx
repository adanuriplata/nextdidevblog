  ...
  return (
    <>
      <section className="md:my-18 my-0">
        <div>
          ...
          <p className="md:text-base text-sm my-2">
            El ser un <span className="text-green-ddev"> profesional </span> en
            tecnología <br /> exige hacer de la{' '}
            <span className="text-green-ddev"> educación </span> continua un
            habito y parte de nuestro{' '}
            <span className="text-green-ddev"> trabajo diario. </span>
          </p>
        </div>
      </section>
      ...
      <section className="mt-12">
        ...
        <CoursesCategory
          courses={courses}
          category={'Emprendimiento y Desarrollo Personal'}
          isLoading={isLoading}
        />
      </section>
    </>
