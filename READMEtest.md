...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `adanuriplata`, `nextdidevblog`, `adanuriplata`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/adanuriplata/nextdidevblog.git
   ```
...
See the [open issues](https://github.com/adanuriplata/nextdidevblog/issues) for a full list of proposed features (and known issues).
